...
const PropertyDetails = ({ propertyDetails: { price, rentFrequency, rooms, title, baths, agency, isVerified, description, type, purpose, furnishingStatus, amenities, photos, area, externalID } }) => (
